export class MigrationNarrative {
  ...
  static OriginWorlds = Object.freeze(['Asteria','Veloran','Nymara','Tharos','Eredyn','Caligo','Orthea','Syr','Mareth','Ilyon','Vaelora','Cyrane','Ossara','Luneth','Tiravel','Auralis','Nerion','Selvara','Kaelor','Myriath','Damaris','Elyndra','Voruna','Iskara','Phaeron','Talmera','Coralis','Zoryn','Avenor','Rhyssa']);
