export class EnemyTypes {
  static Definitions = Object.freeze([
    Object.freeze({ id:'lionArcher', rivalWorldId:'rivalWorld1', baseHealth:70, damage:24, range:9, preferredRange:7, minimumRange:4, speed:1.7, attackCooldown:3.2, windup:1.25, deliveryType:'projectile', projectileType:'arrow', projectileSpeed:7, weapon:'bow', visualProfile:'alpha130.lionArcher' }),
