...
export class CharacterCreationScreen {
  constructor(documentObject = globalThis.document, presentation = null) { this.document = documentObject; this.presentation = presentation; }
  ...
  show(root, worldType, onSubmit) {
    ...
    screen.innerHTML = `<form class="creation-panel"><p class="screen-kicker">IL PRIMO ESSERE DI ELYSIA</p>
      ...
      ${worldType === WorldTypeId.HUMAN ? (this.presentation?.isFamily ? this.familyHumanFields() : this.humanFields()) : this.beastFields()}
  ...
  familyHumanFields() {
    return this.choice('Aspetto / stile del personaggio', 'appearanceStyle', [['1', 'ASPETTO 1'], ['2', 'ASPETTO 2'], ['3', 'ASPETTO 3']]);
  }
